...
<style type="text/css">
.back-img {
	/* background: url("img/kvvfont.png"); */
/*  background: url("img/newcover.png");  */
 
/* 	background: url("img/youngcover.png");  */
	background: url("img/newyoungcover.png");
	height: 80vh;
	width: 100%;
...
<body style="background-color: #EEEEEE">
	...
	<div class="container">
		...
		<div class="text-center mt-2">
			<a href="all_recent_book.jsp"
				class="btn btn-danger btn-sm text-white"><b>View all</b></a>
		</div>
	</div>
	...
	<hr>
	<div class="container">
		<h3 class="text-center mb-3">Books Flip </h3>
		<div class="row">
...
<!-- book start  -->
			<div class="col-md-3">
				<div class="card crd-ho">
					<div class="card-body text-center">
						<img alt="" src="img/EDD.jpg" style="width: 150px; height: 250px"
							class="img-thumblin">
						...
						<div class="row">
							<div class="card-body text-center">
								...
								<a href="bookSwip.jsp" class="btn btn-primary btn-sm ">View Details</a>
							</div>
...
<!-- book End  -->
		...
		<!-- book start  -->
			<div class="col-md-3">
				<div class="card crd-ho">
					<div class="card-body text-center">
						<img alt="" src="img/EE.webp" style="width: 150px; height: 250px"
							class="img-thumblin">
...
<!-- book start  -->
			<div class="col-md-3">
				<div class="card crd-ho">
					<div class="card-body text-center">
						<img alt="" src="img/EM.jpg" style="width: 150px; height: 250px"
							class="img-thumblin">
...
<!-- book End  -->
		...
		<div class="text-center mt-2">
			<a href="all_swip_book.jsp" class="btn btn-danger btn-sm text-white"><b>View
					all</b></a>
...
<!-- book End  -->
		...
		<div class="text-center mt-2">
			<a href="all_donor_book.jsp" class="btn btn-danger btn-sm text-white"><b>View
					all</b></a>
